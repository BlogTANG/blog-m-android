...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navigationView.setCheckedItem(R.id.nav_post_list);
        onNavigationItemSelected(navigationView.getMenu().findItem(R.id.nav_post_list));
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_post_list) {
            getSupportFragmentManager().beginTransaction()
                    .replace(R.id.frag_container, PostListFragment.newInstance())
                    .commit();
        }
